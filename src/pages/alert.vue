<template>
  <div>
    ...
    <Alert show-icon>An info prompt
      <template
        slot="desc"
    ...
    <Alert type="warning" show-icon>A warning prompt
    ...
    <Alert show-icon>Custom icon
      <Icon type="ios-bulb-outline" slot="icon"></Icon>
      <template
        slot="desc"
      >Custom icon copywriting. Custom icon copywriting. Custom icon copywriting.</template>
    </Alert>
